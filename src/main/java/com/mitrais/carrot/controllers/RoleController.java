...
public class RoleController {
	 ...
	 * @return this method will return ResponseEntity Role object with Http Status
	 *         200 if there is no errors
	 */
	@GetMapping("/roles/{id}")
	@ResponseBody
	 ...
	 *
	 * @param id   this variable is Integer type and this is a primary key of Role
	 ...
	 *
	 * @param id his variable is Integer type and this is a primary key of Role that
	 *           you want to mark as delete
	 * @return this method will return ResponseEntity ApiResponse object with Http
	 *         Status 200 if there is no errors
	 */
	...
	public ResponseEntity<ApiResponse> delete(
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse(true, "Data id : " + id + " deleted successfully"),
				HttpStatus.OK);
	}
}
